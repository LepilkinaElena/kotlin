    ...
    fun testNewKotlinJsPlugin(gradleVersion: GradleVersion) {
        project("kotlin-js-plugin-project", gradleVersion) {
            build("publish", "processDceKotlinJs", "test", "processDceBenchmarkKotlinJs") {
                ...
                assertTrue { "kotlinx-html-js</artifactId><version>0.7.2</version><scope>compile</scope>" in pomText }
                ...
                // Requires headless chrome installation on CI
                //assertTestResults(projectPath.resolve("tests.xml"), "browserTest")
            }
        }
    }
